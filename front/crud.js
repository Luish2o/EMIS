...
async function registrarSalida(id, nombreProducto, categoria) {
    ...
    try {
        const response = await fetch('http://localhost:8080/auth/salida', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://localhost:8080/auth/his')
...
function descargarExcel() {
    ...
    console.log("Estado de la tabla antes de descargar:", tabla.style.display);
